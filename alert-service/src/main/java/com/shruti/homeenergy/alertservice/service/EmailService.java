package com.shruti.homeenergy.alertservice.service;

import com.shruti.homeenergy.alertservice.entity.Alert;
import com.shruti.homeenergy.alertservice.repository.AlertRepository;
...
public class EmailService {
    ...
    public void sendEmail(String to, String subject, String body, Long userId){
        ...
        message.setTo(to);
        message.setFrom("noreply@shruti.com");
