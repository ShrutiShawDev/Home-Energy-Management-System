package com.shruti.homeenergy.insight_service.service;

import com.shruti.homeenergy.insight_service.client.UsageClient;
import com.shruti.homeenergy.insight_service.dto.DeviceDto;
import com.shruti.homeenergy.insight_service.dto.InsightDto;
import com.shruti.homeenergy.insight_service.dto.UsageDto;
...
public class InsightService {
    ...
    public InsightDto getSavingTips(Long userId) {
        ...
        double totalUsage = usageData.devices().stream().mapToDouble(
                DeviceDto::energyConsumed
        ).sum();
